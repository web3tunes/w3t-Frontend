            ...
            <div className="col-md-12">
              <div className="sc-box-icon-inner style2">
                <div className="sc-box-icon">
                  ...
                  <p className="content">
                    Register using our Login process using your Google account;
                    email address or just connect an existing wallet
                  </p>
                </div>
                <div className="sc-box-icon">
                  <div className="image">
                  ...
                  <h3 className="heading">Search and Support Your Favs</h3>
                  <p className="content">
                    Check out what your favourite muso’s are up to, what
                    exclusive offers they are making and even own a limited
                    edition unique release.
                  </p>
                </div>
                <div className="sc-box-icon">
                  <div className="image">
                  ...
                  <h3 className="heading">Discover New Talent</h3>
                  <p className="content">
                    Check out our new muso profiles and keep an eye out for our
                    Live Stream Garage Sessions – you might not be able to get
                    to every show, but we plan to bring our muso’s direct to
                    you.
                  </p>
                </div>
                <div className="sc-box-icon">
                  ...
                  <h3 className="heading">Are You a Muso?</h3>
                  <p className="content">
                    Send us a shout-out through our Contact Us page if you want
                    to know more. We’d love to explain how we can help you grow
                    your network and revenues.
                  </p>
                </div>
              </div>
            </div>
