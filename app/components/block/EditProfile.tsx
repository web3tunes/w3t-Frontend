              ...
              <div className="form-upload-profile">
                ...
                <div className="option-profile clearfix">
                  ...
                  {previewUrls.map((url, index) => (
                    <div
                      ...
                      className={`position-relative ${
                        getSelectCover !== null && getSelectCover === index
                          ? "image"
                          : "image style2"
                      }`}
                    ...
                    >
                      <Image
                        height={500}
                        width={500}
                        onClick={() => selectCoverImage(index)}
                        src={url}
                        alt="Conver Photo"
                      />
                      <a
                        onClick={() => deleteConver(url)}
                  ...
                  {previewUrls.length === 0 && (
                    <>
                      <div
                        onClick={() => selectCoverImage(0)}
                        className={
                          getSelectCover !== null && getSelectCover === 0
                            ? "image"
                            : "image style2"
                        }
                        style={{ marginRight: "15px" }}
                      ...
                      <div
                        onClick={() => selectCoverImage(1)}
                        className={
                          getSelectCover !== null && getSelectCover === 1
                            ? "image"
                            : "image style2"
                        }
                      >
