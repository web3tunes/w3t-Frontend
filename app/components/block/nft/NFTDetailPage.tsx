                ...
                <div className="sc-item-details">
                  ...
                  <div className="meta-item-details">
                    <div className="item-style">
                      ...
                      <div className="item-d">
                        <span className="item-head">Price: </span>
                        <span className="item-des">
                  ...
                  <div className="meta-item-details bottom">
                    <div className="item-style">
                      <div className="item-d">
                        <span className="item-head">
                          Base Price in {TOKEN_SYMBOL}:{" "}
                        </span>
                        <span className="item-des">
                          {nftDetails?.price} {TOKEN_SYMBOL} x {quantity} ={" "}
                          {(nftDetails?.price * quantity).toFixed(5)}{" "}
                          {TOKEN_SYMBOL}
                        </span>
                      </div>
                      <div className="item-d">
                        <span className="item-head">Transaction Fee: </span>
                        <span className="item-des">
                          2.5% ={" "}
                          {percentage(
                      ...
                      <div className="item-d">
                        ...
                        <span className="item-des">
                          10% ={" "}
                          {percentage(nftDetails?.price * quantity, 10).toFixed(
                            5
                          )}{" "}
                          {TOKEN_SYMBOL}
                        </span>
                      ...
                      <div className="item-d">
                        <span className="item-head">Total Price: </span>
                        <span className="item-des">
                          {(
                            nftDetails?.price * quantity +
                            percentage(nftDetails?.price * quantity, 2.5) +
                            percentage(nftDetails?.price * quantity, 10)
                          ).toFixed(5)}{" "}
                          {TOKEN_SYMBOL}
                        </span>
                      </div>
