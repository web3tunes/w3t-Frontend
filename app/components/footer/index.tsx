              ...
              <div className="widget widget-logo">
                ...
                <p className="sub-widget-logo">
                  <ul>
                    <li>
                      <a>
                        Giving back to the AUS-NZ music industry we’ve always
                        loved;{" "}
                      </a>
                    </li>
                    <li>
                      <a>
                        A new platform for up-and-coming artists to monetise
                        their talents;{" "}
                      </a>
                    </li>
                    <li>
                      <a>
                        Providing established artists (and labels) the ability
                        to offer unique rewards to their fans.
                      </a>
                    </li>
                  </ul>
                </p>
                <p>© {new Date().getFullYear()} Web3Tunes</p>
              </div>
            </div>
            {/* End col */}
